...
class TestRunnerManager(unittest.TestCase):
    ...
    def setUp(self, return_github_manager, return_openstack_manager) -> None:
        ...
        self.openstack_manager.create_vm_volume.return_value = ObjectId('str'), ObjectId('str')
    ...
    def test_config_vm_type(self, name_generator: Mock,
        ...
        self.assertEqual(r.runners['0'], Runner('0', '1', r.runner_management[0], None))
        self.assertEqual(r.runners['1'].__dict__,
                         Runner('1', '2', r.runner_management[0], None).__dict__)
    ...
    @patch('runners_manager.runner.RunnerManager.RunnerManager.generate_runner_name')
    def test_need_new_runner_current_updated(self, mock_naming):
        ...
        r = RunnerManager('test', [type_dict], self.openstack_manager, self.github_manager)
    ...
    @patch('runners_manager.runner.RunnerManager.RunnerManager.generate_runner_name')
    def test_need_new_runner_current_full(self, mock_naming):
